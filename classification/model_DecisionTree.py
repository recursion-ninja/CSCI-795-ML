...
if best_hyperparameters == None:
    best_hyperparameters = datum.model_selection(DecisionTreeClassifier(), param_grid, X_train_part, Y_train_part)

classifier_NB = DecisionTreeClassifier(**best_hyperparameters)
