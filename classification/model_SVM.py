...
param_grid =    { 'C'           : [10**(i - 4) for i in range(0,9)]
...
if best_hyperparameters == None:
    best_hyperparameters = datum.model_selection(SVC(), param_grid, X_train_part, Y_train_part)

classifier_NB = SVC(**best_hyperparameters)
