...
%--------------------
%\vspace*{-2.25cm}
\title{\texttt{\LARGE{Classifying Creature Combat Capability in \\Dungeons and Dragons 5th Edition} \\\vspace{-0.35cm} {\large A Hunter College CSCI-795 Project Proposal}\\\normalsize\url{https://github.com/recursion-ninja/CSCI-795-ML}}} % Title and subtitle
...
\section*{The D\&D Monster Data}\label{the-dd-monster-data}}
...
Selection}\label{feature-extraction--selection}}
...
discretizing the the 'Elo Rank' column via following procedure:
...
\section{Datset partitioning}\label{datset-partitioning}}
